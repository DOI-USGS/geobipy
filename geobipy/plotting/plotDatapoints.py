...
Parser.add_argument('--points', nargs='+', type=int, default=None, help='Plot the results for these data point indices')
Parser.add_argument('--fiducials', nargs='+', type=float, default=None, help='Plot the results for these data point fiducials')
