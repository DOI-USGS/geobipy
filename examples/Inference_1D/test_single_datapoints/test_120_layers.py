...
par = StatArray(np.linspace(0.001, 3, 120), "Conductivity", "$\frac{S}{m}$")
mod = Model(RectilinearMesh1D(edges=np.r_[np.linspace(0, 350, 120), np.inf]), values=par)
...
kwargs['gradient_standard_deviation'] = 0.1
