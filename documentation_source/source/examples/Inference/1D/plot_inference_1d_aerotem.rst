...
.. image-sg:: /examples/Inference/images/sphx_glr_plot_inference_1d_aerotem_001.png
   :alt: Fiducial [354780.], Time Domain EM Data
   :srcset: /examples/Inference/images/sphx_glr_plot_inference_1d_aerotem_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    i=0, k=2, 0.000 s/Model, 0.008 s Elapsed
    ...
    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    i=1000, k=5, 0.007 s/Model, 7.264 s Elapsed

    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    i=2000, k=7, 0.007 s/Model, 14.196 s Elapsed

    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    i=3000, k=7, 0.007 s/Model, 21.572 s Elapsed

    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    i=4000, k=6, 0.007 s/Model, 28.872 s Elapsed

    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    i=5000, k=8, 0.007 s/Model, 36.267 s Elapsed

    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    i=6000, k=7, 0.007 s/Model, 43.630 s Elapsed

    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/mesh/RectilinearMesh2D.py:358: RuntimeWarning: invalid value encountered in true_divide
      tmp = np.divide(cs, np.expand_dims(total, 1-axis))
    i=7000, k=5, 0.007 s/Model, 50.930 s Elapsed

    i=8000, k=5, 0.008 s/Model, 59.071 s Elapsed

    i=9000, k=5, 0.008 s/Model, 67.438 s Elapsed

    i=10000, k=7, 0.008 s/Model, 75.745 s Elapsed

    i=11000, k=7, 0.009 s/Model, 84.415 s Elapsed

    i=12000, k=6, 0.008 s/Model, 92.698 s Elapsed

    i=13000, k=5, 0.008 s/Model, 100.983 s Elapsed

    i=14000, k=5, 0.008 s/Model, 109.255 s Elapsed

    i=15000, k=6, 0.008 s/Model, 117.555 s Elapsed

    i=16000, k=7, 0.008 s/Model, 125.834 s Elapsed

    i=17000, k=5, 0.009 s/Model, 134.405 s Elapsed

    Remaining Points 0/1 || Elapsed Time: 0:02:15.613463 h:m:s || ETA 0:02:15.613463 h:m:s
...
.. image-sg:: /examples/Inference/images/sphx_glr_plot_inference_1d_aerotem_002.png
   :alt: , Time Domain EM Data
   :srcset: /examples/Inference/images/sphx_glr_plot_inference_1d_aerotem_002.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 2 minutes  17.631 seconds)
