...
.. "examples/Datapoints/plot_frequency_dataset.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_Datapoints_plot_frequency_dataset.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_Datapoints_plot_frequency_dataset.py:
...
.. image-sg:: /examples/Datapoints/images/sphx_glr_plot_frequency_dataset_001.png
   :alt: plot frequency dataset
   :srcset: /examples/Datapoints/images/sphx_glr_plot_frequency_dataset_001.png
...
.. image-sg:: /examples/Datapoints/images/sphx_glr_plot_frequency_dataset_002.png
   :alt: plot frequency dataset
   :srcset: /examples/Datapoints/images/sphx_glr_plot_frequency_dataset_002.png
   :class: sphx-glr-single-img
...
.. image-sg:: /examples/Datapoints/images/sphx_glr_plot_frequency_dataset_003.png
   :alt: plot frequency dataset
   :srcset: /examples/Datapoints/images/sphx_glr_plot_frequency_dataset_003.png
   :class: sphx-glr-single-img
...
.. image-sg:: /examples/Datapoints/images/sphx_glr_plot_frequency_dataset_004.png
   :alt: In_Phase 8171.0
   :srcset: /examples/Datapoints/images/sphx_glr_plot_frequency_dataset_004.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [30010 30020 30030 30040 30050 30060 30070 30080 30090 30100 39010 39020]
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    |   Name:   Fiducial
    |   Shape:  (6710,)
    |   Values: [30000.  30000.1 30000.2 ... 30670.7 30670.8 30670.9]
    |   Min:    30000.0
    |   Max:    30670.9
...
.. image-sg:: /examples/Datapoints/images/sphx_glr_plot_frequency_dataset_005.png
   :alt: plot frequency dataset
   :srcset: /examples/Datapoints/images/sphx_glr_plot_frequency_dataset_005.png
   :class: sphx-glr-single-img
...
.. image-sg:: /examples/Datapoints/images/sphx_glr_plot_frequency_dataset_006.png
   :alt: plot frequency dataset
   :srcset: /examples/Datapoints/images/sphx_glr_plot_frequency_dataset_006.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/nfoks/codes/repositories/geobipy/geobipy/src/classes/data/dataset/Data.py:946: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
...
.. _sphx_glr_download_examples_Datapoints_plot_frequency_dataset.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-zip
      ...
      :download:`Download zipped: plot_frequency_dataset.zip <plot_frequency_dataset.zip>`
